...
var CameraManager = /** @class */ (function () {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                if (this.gui.videoElement.onloadeddata != null) {
                    logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Detected video track \"".concat(event.type, "\" event, delay video stream access detection"));
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        stream = _a.sent();
                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Camera accessed, waiting for video stream start...");
    ...
    CameraManager.prototype.setCameraAccessTimeout = function () {
        var _this = this;
        window.clearTimeout(this.cameraAccessTimeout);
        this.cameraAccessTimeout = window.setTimeout(function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var _a;
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.stopStream(true)];
                    case 1:
                        _b.sent();
