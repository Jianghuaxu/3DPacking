...
function dataCapture() {
    ...
    Module = {
      ...
      instantiateWasm: function instantiateWasm(importObject, successCallback) {
        ...
        if (wasmJSVersion !== "5.9.3") {
          log("error", "The Scandit Data Capture library JS file found at ".concat(jsURI, " seems invalid: ") + "expected version doesn't match (received: ".concat(wasmJSVersion, ", expected: ", "5.9.3", "). ") + "Please ensure the correct Scandit Data Capture file (with correct version) is retrieved.");
        }
  ...
  function getLibraryLocationURIs(libraryLocation, textRecognition, simdSupport) {
    ...
    return {
      jsURI: "".concat(libraryLocation, "scandit-engine-sdk").concat(fileExtension, ".min.js?v=5.9.3"),
      wasmURI: "".concat(libraryLocation, "scandit-engine-sdk").concat(fileExtension, ".wasm?v=5.9.3")
    };
  }
          ...
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
                ...
                Logger.log(Logger.Level.DEBUG, "Detected video track \"".concat(event.type, "\" event, delay video stream access detection"));
          ...
          while (1) {
            switch (_context27.prev = _context27.next) {
              ...
              case 11:
                ...
                Logger.log(Logger.Level.DEBUG, "Camera accessed, waiting for video stream start..."); // Detect weird browser behaviour that on unsupported resolution returns a 2x2 video instead
