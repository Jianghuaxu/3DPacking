...
export function dataCapture() {
            ...
            instantiateWasm: (importObject, successCallback) => {
                ...
                if (wasmJSVersion !== "5.12.0") {
                    log("error", `The Scandit Data Capture library JS file found at ${jsURI} seems invalid: ` +
                        `expected version doesn't match (received: ${wasmJSVersion}, expected: ${"5.12.0"}). ` +
    ...
    function getLibraryLocationURIs(libraryLocation, textRecognition, simdSupport) {
        ...
        return {
            jsURI: `${libraryLocation}scandit-engine-sdk${fileExtension}.min.js?v=5.12.0`,
            wasmURI: `${libraryLocation}scandit-engine-sdk${fileExtension}.wasm?v=5.12.0`,
        };
    }
