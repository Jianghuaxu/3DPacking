...
var Scanner = /** @class */ (function () {
    ...
    Scanner.prototype.applyScanSettings = function (scanSettings) {
        ...
        if (this.blurryRecognitionAvailable) {
            this.activeBlurryRecognitionSymbologies = new Set(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(this.activeBlurryRecognitionSymbologies), false), tslib_1.__read(activeBlurryRecognitionSymbologies), false));
        }
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        _this.eventEmitter.once(workErrorEvent, function (error, _) {
                            logger_1.Logger.log(logger_1.Logger.Level.ERROR, "Scandit Data Capture error (".concat(error.errorCode, "):"), error.errorMessage);
    ...
    Scanner.prototype.parse = function (dataFormat, data, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var parseResultEvent = "parseResult-".concat(_this.workerParseRequestId);
                        var parseErrorEvent = "parseError-".concat(_this.workerParseRequestId);
    ...
    Scanner.prototype.handleBlurryTablesUpdate = function () {
        ...
        this.blurryRecognitionAvailable = index_1.blurryRecognitionPreloader.isBlurryRecognitionAvailable(this.scanSettings);
        if (this.blurryRecognitionAvailable) {
            this.activeBlurryRecognitionSymbologies = new Set(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(this.activeBlurryRecognitionSymbologies), false), tslib_1.__read(index_1.blurryRecognitionPreloader.getEnabledSymbologies(this.scanSettings)), false));
            this.dataCaptureWorker.postMessage({
                type: "scan-settings",
                settings: this.scanSettings.toJSONString(),
        ...
        if (data[0] === "log") {
            data[1].data.forEach(function (dataArgument, index) {
                if (dataArgument.name != null && dataArgument.message != null) {
                    var error = new customError_1.CustomError({ name: dataArgument.name, message: dataArgument.message });
                    error.stack = dataArgument.stack;
                    data[1].data[index] = error;
                }
            });
            logger_1.Logger.log.apply(logger_1.Logger, tslib_1.__spreadArray([data[1].level], tslib_1.__read(data[1].data), false));
            return;
        }
