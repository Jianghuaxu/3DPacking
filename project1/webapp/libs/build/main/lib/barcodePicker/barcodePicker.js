...
var BarcodePicker = /** @class */ (function () {
    function BarcodePicker(originElement, _a) {
        var visible = _a.visible, singleImageModeEnabled = _a.singleImageModeEnabled, singleImageModeSettings = _a.singleImageModeSettings, playSoundOnScan = _a.playSoundOnScan, vibrateOnScan = _a.vibrateOnScan, scanningPaused = _a.scanningPaused, guiStyle = _a.guiStyle, videoFit = _a.videoFit, cameraRecoveryText = _a.cameraRecoveryText, laserArea = _a.laserArea, viewfinderArea = _a.viewfinderArea, scanner = _a.scanner, scanSettings = _a.scanSettings, cameraType = _a.cameraType, targetScanningFPS = _a.targetScanningFPS, hideLogo = _a.hideLogo;
        var _b, _c, _d, _e;
        ...
        this.gui = new gui_1.GUI({
            ...
            videoFit: videoFit,
            hideLogo: hideLogo,
            cameraRecoveryText: cameraRecoveryText,
            laserArea: laserArea,
    ...
    BarcodePicker.create = function (originElement, _a) {
        var _b;
        var _c = _a === void 0 ? {} : _a, _d = _c.visible, visible = _d === void 0 ? true : _d, _e = _c.singleImageModeSettings, singleImageModeSettings = _e === void 0 ? {} : _e, _f = _c.playSoundOnScan, playSoundOnScan = _f === void 0 ? false : _f, _g = _c.vibrateOnScan, vibrateOnScan = _g === void 0 ? false : _g, _h = _c.scanningPaused, scanningPaused = _h === void 0 ? false : _h, _j = _c.guiStyle, guiStyle = _j === void 0 ? BarcodePicker.GuiStyle.LASER : _j, _k = _c.videoFit, videoFit = _k === void 0 ? BarcodePicker.ObjectFit.CONTAIN : _k, _l = _c.cameraRecoveryText, cameraRecoveryText = _l === void 0 ? "Tap/click to resume scanning" : _l, laserArea = _c.laserArea, viewfinderArea = _c.viewfinderArea, scanner = _c.scanner, _m = _c.scanSettings, scanSettings = _m === void 0 ? new scanSettings_1.ScanSettings() : _m, _o = _c.enableCameraSwitcher, enableCameraSwitcher = _o === void 0 ? true : _o, _p = _c.enableTorchToggle, enableTorchToggle = _p === void 0 ? true : _p, _q = _c.enableTapToFocus, enableTapToFocus = _q === void 0 ? true : _q, _r = _c.enablePinchToZoom, enablePinchToZoom = _r === void 0 ? true : _r, _s = _c.accessCamera, accessCamera = _s === void 0 ? true : _s, camera = _c.camera, _t = _c.cameraType, cameraType = _t === void 0 ? camera_1.Camera.Type.BACK : _t, cameraSettings = _c.cameraSettings, _u = _c.targetScanningFPS, targetScanningFPS = _u === void 0 ? 30 : _u, 
        /**
         * @hidden
         */
        _v = _c.hideLogo, 
