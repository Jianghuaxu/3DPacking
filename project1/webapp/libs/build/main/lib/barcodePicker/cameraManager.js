...
var CameraManager = /** @class */ (function () {
    function CameraManager(scanner, triggerCameraAccessError, gui) {
        ...
        this.checkCameraVideoStreamAccessIfVisibleListener = this.checkCameraVideoStreamAccessIfVisible.bind(this);
    ...
    CameraManager.prototype.stopStream = function (cameraInitializationFailure) {
        if (cameraInitializationFailure === void 0) { cameraInitializationFailure = false; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                ...
                if (this.mediaStream != null) {
                    logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Stop camera video stream access".concat(cameraInitializationFailure ? " (abort access detection)" : "", ":"), this.mediaStream);
                    ...
                    return [2 /*return*/, new Promise(function (resolve) {
                            setTimeout(function () {
                                ...
                                if (!cameraInitializationFailure) {
                                    (_b = _this.abortedCameraInitializationResolveCallback) === null || _b === void 0 ? void 0 : _b.call(_this);
                                }
                                resolve();
                            }, 0);
                        })];
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 4:
                        ...
                        return [2 /*return*/];
                    case 5:
                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Initial camera access was incorrect (not main camera), change camera", tslib_1.__assign(tslib_1.__assign({}, initialCamera_1), { deviceId: initialCameraDeviceId_1 }));
                        _d.label = 6;
                    case 6: return [3 /*break*/, 8];
                    case 7:
                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Initial camera access was incorrect (unknown camera), change camera", tslib_1.__assign(tslib_1.__assign({}, initialCamera_1), { deviceId: initialCameraDeviceId_1 }));
                        _d.label = 8;
                    case 8:
    ...
    CameraManager.prototype.checkCameraVideoStreamAccessIfVisible = function () {
        if (document.visibilityState === "visible") {
            logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Page is visible again, waiting for camera video stream start...");
            document.removeEventListener("visibilitychange", this.checkCameraVideoStreamAccessIfVisibleListener);
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(document.visibilityState !== "visible")) return [3 /*break*/, 1];
                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Page is currently not visible, delay camera reinitialization until visible");
    ...
    CameraManager.prototype.videoTrackMuteRecovery = function (event) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var isMuteEvent;
            return tslib_1.__generator(this, function (_a) {
                if (this.gui.videoElement.onloadeddata != null) {
                    logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Detected video track \"".concat(event.type, "\" event, delay camera video stream access detection"));
                    this.setCameraAccessTimeout();
                    return [2 /*return*/];
                }
                isMuteEvent = event.type === "mute";
                if (isMuteEvent !== this.gui.isCameraRecoveryVisible()) {
                    logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Detected video track \"".concat(event.type, "\" event, ").concat(isMuteEvent ? "enable" : "disable", " camera recovery"));
    ...
    CameraManager.prototype.triggerManualFocusForContinuous = function () {
        var _a;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var manualFocusResetNeeded, videoTracks;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (videoTracks.length !== 0 && typeof videoTracks[0].getConstraints === "function") {
                            manualFocusResetNeeded =
                                ((_a = videoTracks[0].getConstraints().advanced) === null || _a === void 0 ? void 0 : _a.some(function (constraint) {
                                    return constraint.focusMode === MeteringMode.MANUAL;
                                })) === true;
                        }
                        if (!manualFocusResetNeeded) return [3 /*break*/, 2];
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.triggerFocusMode(MeteringMode.MANUAL)];
                    case 3:
                        _b.sent();
                        _b.label = 4;
                    case 4: return [2 /*return*/];
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(focusModeCapability instanceof Array)) return [3 /*break*/, 4];
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2:
                        if (!focusModeCapability.includes(MeteringMode.SINGLE_SHOT)) return [3 /*break*/, 4];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        stream = _a.sent();
                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Camera accessed, waiting for camera video stream start...");
                        ...
                        this.mediaStream.getVideoTracks().forEach(function (track) {
                            ...
                            track.addEventListener("unmute", _this.videoTrackMuteListener);
                        });
                        _a.label = 4;
                    case 4:
                        _a.trys.push([4, 6, , 7]);
    ...
    CameraManager.prototype.setCameraAccessTimeout = function () {
        var _this = this;
        window.clearTimeout(this.cameraAccessTimeout);
        this.cameraAccessTimeout = window.setTimeout(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(document.visibilityState !== "visible")) return [3 /*break*/, 1];
                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Page is currently not visible, delay camera video stream access detection");
                        document.addEventListener("visibilitychange", this.checkCameraVideoStreamAccessIfVisibleListener);
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.stopStream(true)];
                    case 2:
                        _b.sent();
                        (_a = this.cameraAccessRejectCallback) === null || _a === void 0 ? void 0 : _a.call(this, new customError_1.CustomError(CameraManager.notReadableErrorParameters));
                        _b.label = 3;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    CameraManager.prototype.checkCameraAccess = function (camera) {
        ...
        return new Promise(function (_, reject) {
            _this.cameraAccessRejectCallback = function (reason) {
                logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Camera video stream access failure (video data load timeout):", camera);
                _this.gui.setCameraRecoveryVisible(true);
                reject(reason);
            };
            _this.setCameraAccessTimeout();
        });
    };
                                ...
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            window.clearInterval(this.videoMetadataCheckInterval);
                                            return [4 /*yield*/, this.stopStream(true)];
                                        case 1:
                                            _a.sent();
    ...
    CameraManager.prototype.setupCameraStreamVideo = function (camera, stream) {
        ...
        var cameraStreamVideoCheck = Promise.race([
            ...
            new Promise(function (resolve) {
                _this.abortedCameraInitializationResolveCallback = resolve;
            }),
        ]);
