	    ...
	    Module = {
	      ...
	      instantiateWasm: function instantiateWasm(importObject, successCallback) {
	        ...
	        if (wasmJSVersion !== "5.12.0") {
	          log("error", "The Scandit Data Capture library JS file found at ".concat(jsURI, " seems invalid: ") + "expected version doesn't match (received: ".concat(wasmJSVersion, ", expected: ", "5.12.0", "). ") + "Please ensure the correct Scandit Data Capture file (with correct version) is retrieved.");
	        }
	    ...
	    var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(resolve, reject) {
	      ...
	      return regenerator.wrap(function _callee$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              exports.Logger.log(exports.Logger.Level.INFO, "Scandit Web SDK version: 5.12.0");
